...
See the [gusty demo Jupyter Notebook Example](https://github.com/chriscardillo/gusty-demo/blob/main/airflow/dags/stock_predictions/stock_data.ipynb) and sample [JupyterOperator](https://github.com/chriscardillo/gusty-demo/blob/main/airflow/operators/jupyter_operator.py).
...
See the [gusty demo Rmd Example](https://github.com/chriscardillo/gusty-demo/blob/main/airflow/dags/stock_predictions/model_predictions.Rmd) and sample [RmdOperator](https://github.com/chriscardillo/gusty-demo/blob/main/airflow/operators/rmd_operator.py).
